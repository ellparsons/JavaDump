...
public class MySpringBootDataAppController {
	...
	//Method to create a vehicle//
		...
		public List<MySpringBootDataModel> getFilmByTitle(@PathVariable(value = "title")String title)
		{
			if (myRepository.findByTitle(title)== null) {
				throw new ResourceNotFoundException("MySpringBootDataModel","title",title);
			}
